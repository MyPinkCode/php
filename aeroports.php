...
<html lang="en">
  <head>
    ...
    <title>Tunisair aeroports</title>
    <link
      rel="stylesheet"
      ...
      <div class="row tm-content-row">
        <div class="col-sm-12 col-md-12 col-lg-8 col-xl-8 tm-block-col">
          ...
          <div class="tm-bg-primary-dark tm-block tm-block-products">
            <form method="POST" action="create_aeroport.php" class="tm-login-form">
            <table class="table table-hover tm-table-small tm-product-table">
              <tbody>
                <tr>
                  <td><input name="nom_aeroport" class="form-control validate" required placeholder="Nom aeroport" type="text" /></td>
                  
                  <td><button type="submit" name="ajout" class="btn btn-primary btn-block text-uppercase">
              Ajouter nouveau aeroport
            </button></td>
                </tr>
              </tbody>
            </table>
            </form>
            <form method="POST" action="create_aeroport.php">
            ...
            <div class="tm-product-table-container">
              ...
              <table class="table table-hover tm-table-small tm-product-table">
                ...
                echo
                  ' <form method="post" action="edit&delete_aeroport.php" class="tm-login-form"><tr>
                  <td class="tm-product-name">'. $row['no_aeroport'] .'<input type="text"  name="no_aeroport" hidden class="form-control" value="'. $row['no_aeroport'] .'"></td>
                    <td scope="row">&nbsp;</td>
              
                    <td><input type="text"  name="nom_aeroport" class="form-control validate" required value="'. $row['nom_aeroport'] .'"></td>
